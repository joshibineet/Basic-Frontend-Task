...
import Among from "../assets/About/Amongst all.png";
import { IoMdCheckmarkCircle } from "react-icons/io";
import { ImWhatsapp } from "react-icons/im";

const Choose = () => {
  return (
    <div className="absolute w-[1440px] mx-auto top-[1000px]">
      <div className="flex flex-col md:flex-row bg-white overflow-hidden">
        <div>
          <img
            src={Among}
            alt="Amongst All"
            className="md:w-[640px] md:h-[580px] object-cover ml-4"
          />
        </div>
        <div className="p-4 relative  w-[580px]">
          <div className="absolute bottom-[565px] flex items-center">
            <div className="w-3.5 sm:w-7 h-0 sm:h-0 border border-[#C2292E]"></div>
            <div className=" text-[#C2292E] text-sm  font-semibold font-[Be Vietnam Pro] leading-tight ml-2 ">
              AMONGST ALL
            </div>
          </div>
      ...
      <div className="flex items-center justify-center w-12 h-12 rounded-full bg-red-700 relative ml-[1160px] cursor-pointer hover:bg-red-700">
