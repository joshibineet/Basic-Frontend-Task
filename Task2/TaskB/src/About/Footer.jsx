...
import logo from "../assets/About/footer logo.png";
import Img from "../assets/About/footerimg.png";
import { VscArrowSmallRight } from "react-icons/vsc";
import Reco from "../assets/About/Recommended.png";
import Assco1 from "../assets/About/Asscoiated1.png";
import Assco2 from "../assets/About/Asscoiated2.png";
import Assco3 from "../assets/About/Asscoiated3.png";
...
const Footer = () => {
  return (
    <footer className="absolute w-full mt-[1630px] left-0 h-[550px] bg-gradient-to-br from-gray-200 via-gray-400 to-gray-400">
      {/* Background Image */}
      <img
        src={Img}
        alt=""
      ...
      {/* Bottom Bar */}
      <div class="border-b border-white border-solid mt-12"></div>
      <div className="bg-gray-400 text-center py-4 flex flex-col md:flex-row items-center  absolute w-full bottom-0 justify-between px-32">
        <p className="text-sm mt-2 md:mb-0 font-medium tracking-wider">
          ...
          <span className="text-red-700"> VRIT TECH</span>
        </p>
