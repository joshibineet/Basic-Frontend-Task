...
import Reco from "../assets/Recommended.png";
import Assco1 from "../assets/Asscoiated1.png";
import Assco2 from "../assets/Asscoiated2.png";
import Assco3 from "../assets/Asscoiated3.png";
...
const Footer = () => {
  return (
    <footer className="absolute w-full mt-[5660px] left-0 h-[550px] bg-gradient-to-br from-gray-200 via-gray-400 to-gray-400">
      {/* Background Image */}
      <img
        src={Img}
        alt=""
